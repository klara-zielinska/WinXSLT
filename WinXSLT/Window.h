...
namespace WinXSLT {
    ...
    ref class Window : public System::Windows::Forms::Form
    {
    public:
        property String^ XSLT
        {
            String^ get()
            { 
                return schemeBox->Text; 
            }

            void set(String^ value) 
            { 
                schemeBox->Text = value;
                schemeBox->Refresh();
            }
        }
        ...
        {
            OpenFileDialog^ get() { return sourceFileDialog; }
        }
        
        property FolderBrowserDialog^ SourceFolderDialog
        {
            FolderBrowserDialog^ get() { return sourceFolderDialog; }
        }
...
#pragma region Windows Form Designer generated code
        ...
        {     
            ...
            this->sourceFileDialog = (gcnew System::Windows::Forms::OpenFileDialog());
...
#pragma endregion
        ...
        System::Void folderClick(
            System::Object^  sender, System::EventArgs^  e)
        {
            controller->ChooseSourceFolder();
        }

        System::Void transformClick(
            System::Object^  sender, System::EventArgs^  e)
        {
